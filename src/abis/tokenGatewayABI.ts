export const tokenGatewayABI = [
  ...
  {
    inputs: [],
    name: 'CanOnlySendValueFromChildChain',
    type: 'error',
  },
  {
    inputs: [],
  ...
  },
  {
    ...
    outputs: [
      {
        internalType: 'contract IShiftPriceFeed',
        name: '',
        type: 'address',
      },
    ],
  ...
  },
  {
    inputs: [
      ...
      {
        internalType: 'enum IShiftConfig.URIType',
        name: 'uriType_',
        type: 'uint8',
      },
    ],
